import { CurrentGameStorage, GameHistory, GamesHistoryStorage, PlayerData } from '../../../infrastructure/storages';
...
export class ShowWinnerCommandHandler {
  ...
  show(): Observable<void> {
    return combineLatest([this.currentGameStorage.playerOne$, this.currentGameStorage.playerTwo$]).pipe(
      ...
      switchMap((result: GameHistory) => this.gamesHistoryStorage.addResult(result)),
